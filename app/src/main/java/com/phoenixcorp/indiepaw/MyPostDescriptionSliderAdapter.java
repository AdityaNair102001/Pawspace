...
public class MyPostDescriptionSliderAdapter extends SliderViewAdapter<MyPostDescriptionSliderAdapter.SliderAdapterVH> {
    ArrayList<String> images;

    public MyPostDescriptionSliderAdapter(ArrayList<String> images) {
        this.images=images;
